...
# * https://github.com/samwhelp/note-about-vim/blob/gh-pages/_demo/project/vimrc-profile/vimrc-get/remote-install.sh
# * https://github.com/samwhelp/note-about-vim/blob/gh-pages/_demo/project/vimrc-profile/vimrc-get/vimrc-get
# * https://raw.githubusercontent.com/samwhelp/note-about-vim/gh-pages/_demo/project/vimrc-profile/vimrc-get/vimrc-get
...
## $ export DEBUG_VIMRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_VIMRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="vimrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-vim/blob/gh-pages/_demo/project/vimrc-profile/vimrc-get/vimrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-vim/gh-pages/_demo/project/vimrc-profile/vimrc-get/vimrc-get'


	THE_TARGET_FILE_NAME="vimrc-get"
