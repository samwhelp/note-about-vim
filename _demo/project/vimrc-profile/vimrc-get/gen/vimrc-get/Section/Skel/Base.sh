...
base_var_init () {
	...
	THE_VIMRC_FILE_NAME="vimrc"
	THE_VIMRC_FILE_PATH="$THE_VIMRC_DIR_PATH/$THE_VIMRC_FILE_NAME"
...
base_var_dump () {
	...
	util_debug_echo "THE_VIMRC_FILE_NAME=$THE_VIMRC_FILE_NAME"
	util_debug_echo "THE_VIMRC_FILE_PATH=$THE_VIMRC_FILE_PATH"
